...
-- ── Candidates ────────────────────────────────────────────────────────────────
INSERT INTO candidates (id, name, email, phone, linkedin, notes, city, state, created_by, updated_by) VALUES
  ('00000000-0000-0000-0004-000000000001', 'Alice Chen',        'alice.chen@email.com',      '+1-415-555-0101', 'linkedin.com/in/alicechen',     '8 years Node.js, previously at Stripe. Strong system design skills.',          'San Francisco', 'CA', '00000000-0000-0000-0000-000000000002', '00000000-0000-0000-0000-000000000002'),
  ('00000000-0000-0000-0004-000000000002', 'Brian Okafor',      'brian.okafor@email.com',    '+1-512-555-0102', 'linkedin.com/in/brianokafor',    'Full-stack engineer, solid React and PostgreSQL experience.',                   'Austin',        'TX', '00000000-0000-0000-0000-000000000002', '00000000-0000-0000-0000-000000000002'),
  ('00000000-0000-0000-0004-000000000003', 'Carmen Reyes',      'carmen.reyes@email.com',    '+1-212-555-0103', 'linkedin.com/in/carmenreyes',    'Senior UX Designer, 6 years at consumer tech startups. Great portfolio.',      'New York',      'NY', '00000000-0000-0000-0000-000000000002', '00000000-0000-0000-0000-000000000002'),
  ('00000000-0000-0000-0004-000000000004', 'David Kim',         'david.kim@email.com',       '+1-415-555-0104', 'linkedin.com/in/davidkim',       'Product Manager with deep experience in B2B SaaS. MBA from Stanford.',         'San Francisco', 'CA', '00000000-0000-0000-0000-000000000002', '00000000-0000-0000-0000-000000000002'),
  ('00000000-0000-0000-0004-000000000005', 'Emily Nguyen',      'emily.nguyen@email.com',    '+1-312-555-0105', 'linkedin.com/in/emilynguyen',    'DevOps engineer, strong Kubernetes and Terraform background.',                  'Chicago',       'IL', '00000000-0000-0000-0000-000000000002', '00000000-0000-0000-0000-000000000002'),
  ('00000000-0000-0000-0004-000000000006', 'Frank Torres',      'frank.torres@email.com',    '+1-212-555-0106', NULL,                             'Sales rep, 5 years SaaS experience, consistently exceeds quota.',              'New York',      'NY', '00000000-0000-0000-0000-000000000002', '00000000-0000-0000-0000-000000000002'),
  ('00000000-0000-0000-0004-000000000007', 'Grace Liu',         'grace.liu@email.com',       '+1-415-555-0107', 'linkedin.com/in/graceliu',       'Frontend specialist, React + TypeScript, open-source contributor.',            'San Francisco', 'CA', '00000000-0000-0000-0000-000000000002', '00000000-0000-0000-0000-000000000002'),
  ('00000000-0000-0000-0004-000000000008', 'Henry Walker',      'henry.walker@email.com',    '+1-737-555-0108', 'linkedin.com/in/henrywalker',    'Backend developer with Node.js and GraphQL focus.',                            'Austin',        'TX', '00000000-0000-0000-0000-000000000002', '00000000-0000-0000-0000-000000000002'),
  ('00000000-0000-0000-0004-000000000009', 'Isabel Martinez',   'isabel.martinez@email.com', '+1-212-555-0109', 'linkedin.com/in/isabelmartinez', 'HR generalist, 4 years in tech companies, great communicator.',               'New York',      'NY', '00000000-0000-0000-0000-000000000002', '00000000-0000-0000-0000-000000000002'),
  ('00000000-0000-0000-0004-000000000010', 'James Park',        'james.park@email.com',      '+1-415-555-0110', 'linkedin.com/in/jamespark',      'Senior engineer, Go and Kubernetes, previously at Google.',                    'San Francisco', 'CA', '00000000-0000-0000-0000-000000000002', '00000000-0000-0000-0000-000000000002'),
  ('00000000-0000-0000-0004-000000000011', 'Karen Brown',       'karen.brown@email.com',     '+1-312-555-0111', 'linkedin.com/in/karenbrown',     'Data analyst, strong SQL and Python. Experience with dbt and Looker.',         'Chicago',       'IL', '00000000-0000-0000-0000-000000000002', '00000000-0000-0000-0000-000000000002'),
  ('00000000-0000-0000-0004-000000000012', 'Leo Fernandez',     'leo.fernandez@email.com',   '+1-737-555-0112', NULL,                             'Marketing manager, led growth campaigns at two SaaS startups.',               'Austin',        'TX', '00000000-0000-0000-0000-000000000002', '00000000-0000-0000-0000-000000000002'),
  ('00000000-0000-0000-0004-000000000013', 'Mia Johnson',       'mia.johnson@email.com',     '+1-212-555-0113', 'linkedin.com/in/miajohnson',     'UX designer with strong research and prototyping skills. Figma expert.',      'New York',      'NY', '00000000-0000-0000-0000-000000000002', '00000000-0000-0000-0000-000000000002'),
  ('00000000-0000-0000-0004-000000000014', 'Nathan Scott',      'nathan.scott@email.com',    '+1-415-555-0114', 'linkedin.com/in/nathanscott',    'Full-stack developer, 4 years exp. React + Node + PostgreSQL.',               'San Francisco', 'CA', '00000000-0000-0000-0000-000000000002', '00000000-0000-0000-0000-000000000002'),
  ('00000000-0000-0000-0004-000000000015', 'Olivia Wright',     'olivia.wright@email.com',   '+1-312-555-0115', 'linkedin.com/in/oliviawright',   'Contract backend developer, available immediately. Strong REST API skills.',   'Chicago',       'IL', '00000000-0000-0000-0000-000000000002', '00000000-0000-0000-0000-000000000002')
ON CONFLICT (id) DO NOTHING;
